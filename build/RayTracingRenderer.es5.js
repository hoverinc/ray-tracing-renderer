(function (global, factory) {
  ...
  function makeMaterialBuffer(gl, materials) {
    ...
    bufferData.useVertexColors = materials.map(function (m) {
  ...
  function mergeMeshesToGeometry(meshes) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var _geometry = mesh.geometry.isBufferGeometry ? cloneBufferGeometry(mesh.geometry, ['position', 'normal', 'uv', 'color']) : // BufferGeometry object
  ...
  function mergeGeometry(geometryAndMaterialIndex, vertexCount, indexCount) {
    ...
    var vertexColorAttrib = new THREE$1.BufferAttribute(new Float32Array(4 * vertexCount), 4, false);
